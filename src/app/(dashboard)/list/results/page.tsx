...
import { examsData, parentsData, resultsData, role, studentsData, teachersData } from '@/lib/data'
              ...
              <Link href={`results/${item.id}`}>
                <button className="w-7 h-7 rounded-full flex items-center justify-center bg-lamaSky">
                  <Image src={"/view.png"} alt="" width={16} height={16} />
                                ...
                                <FormComponent type='delete' table='results' id={item.id}  />
              </>
  ...
  return (
    ...
    <div className='bg-white  mx-4 p-4  flex-1 rounded-xl'>
        ...
        <Image src="/sort.png" alt='' width={14} height={14}/>
            ...
            {
                role === "admin" && 
                <FormComponent type='create' table='results'  />
}
        </div>
        </div>
        </div>
