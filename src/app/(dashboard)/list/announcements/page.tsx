...
return( <tr key={item.id} className='border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLight'>
          ...
          <td>
            ...
            <FormComponent type='update' table='announcements' data={item} />

             

              { role === "admin" && 
                                                                <FormComponent type='create' table='announcements' id={item.id} />
  ...
  return (
    ...
    <div className='bg-white  mx-4 p-4  flex-1 rounded-xl'>
        ...
        <Image src="/sort.png" alt='' width={14} height={14}/>
            ...
            {
                role === "admin" && 
                                                <FormComponent type='create' table='announcements'  />
                }
        </div>
        </div>
        </div>
